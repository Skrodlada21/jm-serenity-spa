...
(function () {
  ...
  var DICT = {
    ...
    "Today": "今天", "New Booking": "新预约", "Gift Cards": "礼品卡", "Members": "会员", "Prep Board": "准备板",
    // ---- Buttons / actions ----
    ...
    "Work Schedule": "工作排班", "Reminder Time": "提醒时间", "Good For": "适合", "Photo": "照片",
    "Image": "图片", "File": "文件", "Receipt": "收据", "Caption": "说明文字", "Sort Order": "排序",
    "Featured": "精选", "Gender": "性别", "Therapist(s)": "理疗师", "Second Therapist": "第二位理疗师",
    "Therapist Preference": "理疗师偏好", "Your PIN": "您的密码", "Your Employee PIN": "您的员工密码",
    ...
    "Notes for Therapist": "给理疗师的备注", "Message": "留言", "Personal Message": "个人留言",
    ...
    "Services This Therapist Can Perform": "该理疗师可提供的服务", "NOT PAID": "未付款", "MEMBER": "会员",
    "On Schedule": "在排班", "Off Schedule": "不在排班", "Fired": "已解雇", "Fired / Let Go": "已解雇 / 辞退",
    "They Left / Quit": "已离职 / 辞职", "Walk-In": "免预约", "Other Payment": "其他付款",
